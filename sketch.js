...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
     gameState = END;
     player1.velocityY = 0;
     player1.addAnimation(oppPink2Img);
    }
    
    if(yellowCG.isTouching(mainCyclist)){
      gameState = END;
      player2.velocityY = 0;
      player2.addAnimation(oppYellow2Img);
    }
    
    if(redCG.isTouching(mainCyclist)){
      gameState = END;
      player3.velocityY = 0;
      player3.addAnimation(oppRed2Img);
    }
...
function pinkCyclists(){
        ...
        player1.addAnimation(oppPink1Img);
...
function yellowCyclists(){
        ...
        player2.addAnimation(oppYellow1Img);
...
function redCyclists(){
        ...
        player3.addAnimation(oppRed1Img);
